      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pegawai /</span> Tambah Data<a href="pegawai_show.php" class="mx-2 btn rounded-pill btn-warning">
            ...
            if (isset($_POST['Submit'])) {
              ...
              $insert_data = mysqli_query($con, "INSERT INTO pegawai(nama, jenis_kelamin, agama, alamat, no_telp, email, id_jabatan, id_gaji, id_user) VALUES ('$nama', '$jenis_kelamin', '$agama', '$alamat', '$no_telp', '$email', '$id_jabatan', '$id_gaji', '$id_user')");
            ...
            <div class="row">
              <div class="col-xl">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <form action="pegawai_add.php" method="post">
                      <div class="mb-3">
                        ...
                        <select id="id_gaji" name="id_gaji" class="form-select" required>
                          ...
                          if (mysqli_num_rows($gaji_query) > 0) {
                            while ($data = mysqli_fetch_assoc($gaji_query)) {
                              echo '<option value="' . $data['id_gaji'] . '" >Rp ' . number_format($data['gaji'], 2, ',', '.') . '</option>';
                            }
                          }
                          ?>
                        </select>
