        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pengawasan /</span> Tambah Data<a href="pengawasan_show.php" class="mx-2 btn rounded-pill btn-warning">
              ...
              <?php
                if(isset($_POST['Submit'])) {
                    ...
                    $insert_data = mysqli_query($con, "INSERT INTO pengawasan(nama_proyek, tgl_mulai, tgl_selesai, kemajuan, jenis_proyek, keterangan) VALUES ('$nama_proyek', '$tgl_mulai', '$tgl_selesai', '$kemajuan', '$jenis_proyek', '$keterangan')") or die(mysqli_error($con));
              ...
              <div class="row">
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="pengawasan_add.php" method="post">
                        <div class="mb-3">
                          <label class="form-label" for="nama_proyek">Nama Project</label>
                          <input type="text" class="form-control" id="nama_proyek" name="nama_proyek" placeholder="Nama Project" required />
                        </div>
                        <div class="mb-3">
