      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Jabatan /</span> Tambah Data<a href="jabatan_show.php" class="mx-2 btn rounded-pill btn-warning">
            ...
            if (isset($_POST['Submit'])) {
              ...
              $insert_data = mysqli_query($con, "INSERT INTO jabatan(nama_jabatan) VALUES ('$nama_jabatan')");
            ...
            <div class="row">
              <div class="col-xl">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <form action="jabatan_add.php" method="post">
                      <div class="mb-3">
