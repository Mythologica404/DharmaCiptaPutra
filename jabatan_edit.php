...
if (!isset($_GET['id'])) {
  ...
  $id = $_GET['id'];
  $find_data = mysqli_query($con, "SELECT * FROM jabatan WHERE id_jabatan = $id") or die(mysqli_error($con));

  $data = mysqli_fetch_assoc($find_data);
  $data_edit1 = $data['id_jabatan'];
  $data_edit2 = $data['nama_jabatan'];
}
?>
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Jabatan /</span> Edit Data
              <a href="jabatan_show.php" class="mx-2 btn rounded-pill btn-warning">
            ...
            if (isset($_POST['Submit'])) {
              ...
              $update_data = mysqli_query($con, "UPDATE jabatan SET nama_jabatan = '$nama_jabatan' WHERE jabatan.id_jabatan = $id;") or die(mysqli_error($con));
            ...
            <div class="row">
              <div class="col-xl">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <form action="jabatan_edit.php?id=<?= $id ?>" method="post">
                      <div class="mb-3">
                        <label class="form-label" for="nama_jabatan">Nama Jabatan</label>
                        <input type="hidden" name="id" value="<?= $_GET['id'] ?>">
                        <input type="text" class="form-control" id="nama_jabatan" name="nama_jabatan" placeholder="Nama Jabatan" value="<?= $data_edit2 ?>" required />
                      </div>
