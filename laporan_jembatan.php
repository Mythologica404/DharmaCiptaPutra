            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Laporan /</span> Jembatan</h4>



                        <!-- Striped Rows -->
                        <div class="card">
                            <h5 class="card-header">Tabel Project Jembatan
                            </h5>
                            <div class="table-responsive text-nowrap">
                                <table id="table_pengawasan" class="table table-striped">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <?php
                                        $pengawasanQuery = mysqli_query($con, "SELECT * FROM pengawasan WHERE jenis_proyek = 'Jembatan'");
    ...
    <script>
        $("#table_pengawasan").DataTable({
            ...
            buttons: [{
                    ...
                    title: "Daftar Project Jembatan - CV. Dharma Cipta Pratama",
                    download: "open",
                    exportOptions: {
