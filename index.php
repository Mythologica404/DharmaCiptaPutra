                ...
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Sistem Informasi Pegawai - CV. Dharma Cipta Putra</h5>
                          <p class="mb-4">
                            Ini adalah sebuah aplikasi untuk Sistem Informasi Pegawai di CV. Dharma Cipta Putra
                          </p>
